...
Wow! Compelling stuff. Bet you're on the edge of your seat right now. Well now's the moment of truth. The big reveal. If using an R code chunk, you simply put a "py$"" in front of whatever the python varaible is.

```{R}
R_chunk + py$python_chunk
```

There you have it! The 7 R value and the 13 python value added up to 20. As simple as it seems, without reticulate the computer would not be able to do this. But that's not all! You can even use reticulate in a python chunk by putting "r." in front of the variable name
